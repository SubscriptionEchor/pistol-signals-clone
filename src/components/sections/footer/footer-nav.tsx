...
const navigation = [
  ...
  { label: 'support@pistolsignals.com', navigate: true, },
  { label: 'Roadmap', href: '#roadmap', isLaunching: true },
  // { label: 'Affiliates', href: '#affiliates', navigate: true, route: '/affiliate' },
];
    ...
    <nav className="flex flex-wrap justify-center gap-x-8 gap-y-4">
      {navigation.map((item, index) => (
        <motion.a
          ...
          className={`text-sm transition-all relative group ${item.isLaunching
