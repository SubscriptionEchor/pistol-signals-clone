...
export function FeatureCard({ icon: Icon, title, description, iconColor, delay = 0 }: FeatureCardProps) {
  return (
    ...
    >
      ...
      <div className="absolute -inset-px bg-gradient-to-r from-[#4F46E5]/10 via-[#6366F1]/10 to-[#8B5CF6]/10 opacity-0 group-hover:opacity-100 blur-sm transition-opacity duration-500" />
      ...
      <div className="relative">
        ...
        <h3 className="text-lg font-semibold mb-2 group-hover:text-[#6366F1] transition-colors duration-300">
          {title}
        </h3>
